...
.hero-right-overlay-bottom {
    position: absolute;
    inset: 0;
    background: linear-gradient(to top, rgba(240, 244, 255, 0.3) 0%, transparent 40%);
}
...
.feature-card:hover {
    box-shadow: 0 8px 32px rgba(0, 106, 215, 0.15);
...
.regl-badge {
    background: linear-gradient(135deg, #21277B, #006AD7);
    color: #fff;
    padding: 12px 22px;
    border-radius: 12px;
    font-size: 13px;
...
.regl-item:hover {
    box-shadow: 0 4px 20px rgba(0, 106, 215, 0.10);
}
...
.regl-trigger.open .regl-trigger-arrow {
...
.regl-section-title:first-child {
    margin-top: 0;
}
...
.regl-table tr:nth-child(even) td {
    background: #f5f8ff;
}
...
<section class="hero">
    <div class="hero-left">
        ...
        <p class="hero-sub">SyndicPro réunit syndics et copropriétaires dans une plateforme unique, intuitive et
            sécurisée.</p>
        <div class="hero-btns">
...
{{-- STATS --}}
<div class="stats">
    <div class="stat"><span class="stat-num">1 200+</span>
        <div class="stat-label">Résidences gérées</div>
    </div>
    <div class="stat"><span class="stat-num">98 %</span>
        <div class="stat-label">Satisfaction client</div>
    </div>
    <div class="stat"><span class="stat-num">45 000+</span>
        <div class="stat-label">Résidents connectés</div>
    </div>
</div>
...
<section class="testimonials">
    ...
    <div class="testimonials-grid">
        <div class="testi-card">
            ...
            <p class="testi-text">"SyndicPro a divisé par 3 le temps que je consacrais à la gestion administrative.
                Indispensable."</p>
        ...
        <div class="testi-card">
            <div class="testi-stars">★★★★★</div>
            <p class="testi-text">"Enfin une plateforme où tous les copropriétaires s'y retrouvent, même les moins
                technophiles."</p>
            <div class="testi-author">
        ...
        <div class="testi-card">
            <div class="testi-stars">★★★★★</div>
            <p class="testi-text">"La gestion des AG en ligne a transformé notre façon de travailler. Un gain de temps
                considérable."</p>
            <div class="testi-author">
...
<section class="reglementation" id="reglementation">
    <div class="regl-header">
        <div class="regl-header-left">
            ...
            <p>Tout ce que vous devez savoir sur le cadre juridique marocain régissant la gestion des copropriétés — Loi
                18.00.</p>
        </div>
    ...
    <div class="regl-accordion">
        ...
        <div class="regl-item">
            ...
            <div class="regl-content">
                <p class="regl-text">La Loi n° 18.00 relative au statut de la copropriété des immeubles bâtis est le
                    texte fondamental régissant la vie en copropriété au Maroc. Elle a été promulguée par le Dahir n°
                    1-02-298 du 25 rejeb 1423 (3 octobre 2002) et publiée au Bulletin Officiel n° 5400 du 3 novembre
                    2002.</p>
                <table class="regl-table">
                    ...
                    <tr>
                        <td>Intitulé</td>
                        <td>Loi relative au statut de la copropriété des immeubles bâtis</td>
                    </tr>
                    <tr>
                        <td>Numéro</td>
                        <td>Loi 18.00</td>
                    ...
                    <tr>
                        <td>Publication</td>
                        <td>Bulletin Officiel n° 5400 — 3 novembre 2002</td>
                    </tr>
                    <tr>
                        <td>Décret d'application</td>
                        <td>Décret n° 2-03-310 du 30 septembre 2003</td>
                    </tr>
                    <tr>
                        <td>Modification</td>
                        <td>Décret n° 2-16-301 (2016)</td>
                    </tr>
                </table>
        ...
        <div class="regl-item">
            ...
            <div class="regl-content">
                ...
                <p class="regl-text">Immeuble bâti dont la propriété est répartie entre plusieurs personnes par lots
                    comprenant une partie privative et une quote-part des parties communes.</p>
                <p class="regl-section-title">Les Parties Privatives</p>
                <p class="regl-text">Parties de l'immeuble à usage exclusif d'un copropriétaire : appartements, locaux
                    commerciaux, caves, parkings attribués individuellement.</p>
                ...
                <p class="regl-text">Personne morale de droit privé regroupant tous les copropriétaires, chargée de la
                    conservation de l'immeuble et de l'administration des parties communes.</p>
                <p class="regl-section-title">Le Syndic</p>
                <p class="regl-text">Personne physique ou morale désignée par l'assemblée générale pour gérer
                    l'immeuble. Il est le mandataire légal du syndicat.</p>
                <div class="regl-note">💡 Dans SyndicPro, le rôle "Syndic" correspond à ce mandataire légal disposant de
                    tous les pouvoirs de gestion.</div>
            </div>
        </div>
        ...
        <div class="regl-item">
            ...
            <div class="regl-content">
                ...
                <div class="regl-note">💡 SyndicPro automatise ces obligations via les modules Factures, Réclamations,
                    Fournisseurs et Tableau de bord.</div>
            </div>
        </div>
        ...
        <div class="regl-item">
            ...
            <div class="regl-content">
                ...
                <p class="regl-text">L'assemblée générale ordinaire doit être convoquée au moins une fois par an. La
                    convocation doit être adressée à chaque copropriétaire par lettre recommandée, au moins <strong>15
                        jours</strong> avant la réunion.</p>
                ...
                <table class="regl-table">
                    ...
                    <tr>
                        <td>Décisions courantes de gestion</td>
                        <td>Majorité simple (50% + 1)</td>
                    </tr>
                    <tr>
                        <td>Travaux d'amélioration</td>
                        <td>Majorité absolue (2/3 des voix)</td>
                    </tr>
                    <tr>
                        <td>Modification du règlement</td>
                        <td>Majorité qualifiée</td>
                    </tr>
                    <tr>
                        <td>Changement de destination</td>
                        <td>Unanimité</td>
                    </tr>
                    <tr>
                        <td>Vente des parties communes</td>
                        <td>Unanimité</td>
                    </tr>
                </table>
                <p class="regl-section-title">Procès-Verbal</p>
                <p class="regl-text">Les délibérations font l'objet d'un procès-verbal, adressé à tous les
                    copropriétaires dans les <strong>8 jours</strong> suivant la réunion.</p>
                <div class="regl-note">💡 SyndicPro génère automatiquement les PV et les distribue numériquement à tous
                    les copropriétaires.</div>
            </div>
        </div>
        ...
        <div class="regl-item">
            ...
            <div class="regl-content">
                ...
                <p class="regl-text">Concernent la conservation, l'entretien et l'administration des parties communes.
                    Réparties entre tous les copropriétaires proportionnellement à leurs quotes-parts.</p>
                <p class="regl-section-title">Charges Spéciales</p>
                <p class="regl-text">Concernent les services et équipements dont certains copropriétaires ne profitent
                    pas. Réparties uniquement entre les copropriétaires concernés.</p>
                <p class="regl-section-title">Fonds de Réserve</p>
                <p class="regl-text">L'assemblée générale peut décider la constitution d'un fonds de réserve pour
                    financer les travaux importants. Ce fonds est géré séparément des charges courantes.</p>
                <div class="regl-note">💡 Le module Factures de SyndicPro gère le calcul automatique et l'émission des
                    appels de fonds pour chaque copropriétaire.</div>
            </div>
        </div>
        ...
        <div class="regl-item">
            ...
            <div class="regl-content">
                ...
                <p class="regl-text">Peuvent être décidés par le syndic sans autorisation préalable de l'assemblée
                    générale, dans la limite du budget voté.</p>
                <p class="regl-section-title">Travaux Urgents</p>
                <p class="regl-text">En cas d'urgence, le syndic peut faire exécuter les travaux nécessaires à la
                    sauvegarde de l'immeuble sans attendre une assemblée générale, puis en informer immédiatement les
                    copropriétaires.</p>
                <p class="regl-section-title">Travaux d'Amélioration</p>
                <p class="regl-text">Doivent être votés en assemblée générale à la <strong>majorité des deux
                        tiers</strong>. Ils font l'objet d'un appel de fonds spécifique.</p>
                <div class="regl-note">💡 Le module Réclamations et Fournisseurs de SyndicPro assure le suivi complet
                    des interventions.</div>
            </div>
        </div>
        ...
        <div class="regl-item">
            ...
            <div class="regl-content">
                ...
                <p class="regl-text">Tout copropriétaire peut contester une décision de l'assemblée générale devant le
                    tribunal compétent dans un délai de <strong>2 mois</strong> suivant la notification du
                    procès-verbal.</p>
                ...
                <table class="regl-table">
                    ...
                    <tr>
                        <td>Litiges entre copropriétaires</td>
                        <td>Tribunal de première instance</td>
                    </tr>
                    <tr>
                        <td>Litiges avec le syndic</td>
                        <td>Tribunal de première instance</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Nullité d'assemblée générale</td>
                        <td>Tribunal de première instance</td>
                    </tr>
                </table>
...
<section class="contact-section" id="contact">
    ...
    <div class="contact-cards">
        <div class="contact-card">
            ...
            <h3>Email</h3>
            <p>contact@syndicpro.ma</p><span>Réponse sous 24h</span>
        </div>
        <div class="contact-card">
            <div class="contact-card-icon">📞</div>
            <h3>Téléphone</h3>
            <p>+212 5 22 00 00 00</p><span>Lun – Ven, 9h – 18h</span>
        </div>
        <div class="contact-card">
            <div class="contact-card-icon">📍</div>
            <h3>Adresse</h3>
            <p>Casablanca, Maroc</p><span>Maarif, 20100</span>
        </div>
    </div>
</section>
...
document.addEventListener('DOMContentLoaded', function() {
    if (window.location.hash === '#reglementation') {
        setTimeout(() => {
            document.getElementById('reglementation')?.scrollIntoView({
                behavior: 'smooth'
            });
        }, 300);
    }
