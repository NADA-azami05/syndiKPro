        ...
        <main class="mc">
            <div class="form-wrap">
                ...
                <div class="form-hero">
                    ...
                    <p>Remplissez les informations du nouveau résident</p>
                </div>

                <div class="form-body">
                    <form action="{{ route('syndic.residents.store') }}" method="POST">
                        @csrf

                        <div class="fg-row">
                            <div class="fg">
                                <label>Nom complet</label>
                                <input type="text" name="name" placeholder="Ex: Ahmed Benali" value="{{ old('name') }}"
                                    required>
                                @error('name') <div class="err">{{ $message }}</div> @enderror
                            </div>
                            <div class="fg">
                                <label>Téléphone</label>
                                <input type="text" name="phone" placeholder="Ex: 06 12 34 56 78" value="{{ old('phone') }}">
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn-submit">💾 &nbsp; Enregistrer le résident</button>
