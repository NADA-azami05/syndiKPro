...
<div class="dw">
    ...
    <main class="mc">
        ...
        <div class="dc" style="text-align:center;padding:60px">
            ...
            <h2 style="font-family:var(--font-serif);font-size:20px;color:#111;margin-bottom:10px">Profil non configuré
            </h2>
        ...
        <div class="pb">
            ...
            <div>
                ...
                <div class="pbs">
                    <span
                        class="pba">{{ $resident->type === 'proprietaire' ? '🏠 Propriétaire' : '🔑 Locataire' }}</span>
        ...
        <div class="kg">
            <div class="kc">
                <div class="ki b">📄</div>
                <div>
                    <div class="kn">{{ $factures->count() }}</div>
                    <div class="kl">Factures récentes</div>
                </div>
            </div>
            <div class="kc">
                <div class="ki g">✅</div>
                <div>
                    <div class="kn">{{ $factures->where('statut', 'payee')->count() }}</div>
                    <div class="kl">Factures payées</div>
                </div>
            </div>
            <div class="kc">
                <div class="ki o">📢</div>
                <div>
                    <div class="kn">{{ $reclamations->count() }}</div>
        ...
        <div class="g2">
            <div class="dc">
                ...
                <div class="ir">
                    <div class="ii">👤</div>
                    <div>
                        <div class="il">Nom complet</div>
                        <div class="iv">{{ auth()->user()->name }}</div>
                    </div>
                </div>
                <div class="ir">
                    <div class="ii">📧</div>
                    <div>
                        ...
                        <div class="iv">{{ auth()->user()->email }}</div>
                    </div>
                </div>
                <div class="ir">
                    <div class="ii">📞</div>
                    <div>
                        ...
                        <div class="iv">{{ $resident->telephone ?? 'Non renseigné' }}</div>
                    </div>
                </div>
                <div class="ir">
                    <div class="ii">🏠</div>
                    <div>
                        ...
                        <div class="iv">{{ ucfirst($resident->type) }}</div>
                    </div>
                </div>
                <div class="ir">
                    <div class="ii">📅</div>
                    <div>
                        <div class="il">Membre depuis</div>
                        <div class="iv">{{ $resident->created_at->format('d/m/Y') }}</div>
                    </div>
                </div>
            </div>
            <div class="dc">
                ...
                <div class="lh">
                    ...
                    <div>
                        <div class="ln">Lot {{ $resident->lot->numero }}</div>
                        <div class="ls">{{ ucfirst($resident->lot->type) }}</div>
                    </div>
                </div>
                <div class="ir">
                    <div class="ii">📐</div>
                    <div>
                        ...
                        <div class="iv">{{ $resident->lot->surface }} m²</div>
                    </div>
                </div>
                <div class="ir">
                    <div class="ii">📊</div>
                    <div>
                        <div class="il">Quote-part</div>
                        <div class="iv">{{ $resident->lot->quote_part }} %</div>
                    </div>
                </div>
                ...
                <div class="ir">
                    <div class="ii">🏙️</div>
                    <div>
                        <div class="il">Résidence</div>
                        <div class="iv">{{ $resident->lot->copropriete->nom }}</div>
                    </div>
                </div>
                <div class="ir">
                    <div class="ii">📍</div>
                    <div>
                        ...
                        <div class="iv">{{ $resident->lot->copropriete->adresse }},
                            {{ $resident->lot->copropriete->ville }}</div>
                    </div>
                </div>
                @endif
                @else
