        ...
        <main class="mc">
            ...
            <div class="stats-row">
                <div class="stat-card">
                    ...
                    <div>
                        <div class="stat-num">{{ $coproprietes->total() }}</div>
                        <div class="stat-label">Total copropriétés</div>
                    </div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon">🏠</div>
                    <div>
                        <div class="stat-num">{{ $coproprietes->sum('lots_count') }}</div>
                ...
                <div class="stat-card">
                    <div class="stat-icon">💰</div>
                    <div>
                        <div class="stat-num">{{ number_format($coproprietes->sum('budget') / 1000, 0) }}k</div>
                        ...
                        <tbody id="tableBody">
                            @foreach($coproprietes as $c)
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            <a href="{{ route('syndic.coproprietes.edit', $c) }}" class="btn-secondary">✏️
                                                Modifier</a>
                                            <form action="{{ route('syndic.coproprietes.destroy', $c) }}" method="POST"
